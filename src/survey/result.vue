        ...
        <div class="p-6 space-y-6">
          ...
          <div class="mt-6 bg-gray-50 border border-purple-700 shadow-lg p-5 rounded-lg flex items-start">
            ...
            <div>
              ...
              <p class="text-gray-500">Your custom report includes insights from the following chapters:</p>
              <ul class="mt-3 list-disc list-inside text-gray-500 font-semibold">
