...
const phases = ref([
  {
    title: "Exploration",
    description:
      "Scan the external environment and assess internal readiness to identify trends, capabilities, and stakeholder engagement opportunities.",
    activities: [
    ...
    resources: [
      ...
      {
        title: "Foresight Framework - Context Maps (p. 60)",
        type: "Perspective",
      },
      {
        title: "Foresight Framework - Progression Curves (p. 70)",
        type: "Perspective",
      },
      {
        title: "Foresight Framework - Janus Cones (p. 82)",
        type: "Perspective",
      },
    ],
    indicators: [
...

  {
    ...
    description:
      "Evaluate innovation options, prioritize projects, and develop a strategic, scalable plan aligned with institutional vision and capabilities.",
    activities: [
    ...
    resources: [
      {
        title: "Innovation Portfolio Matrix (Tidd & Bessant, Ch. 4)",
        type: "Framework",
      },
      {
        title: "Cost-Impact Mapping (Tidd & Bessant, Ch. 5)",
        type: "Framework",
      },
      {
        title: "Decision-Making Frameworks (Scoring Matrices, MoSCoW)",
        type: "Framework",
      },
      { title: "Strategic Alignment Rubrics", type: "Document" },
      {
        title: "Foresight Framework - White Spots (p. 130)",
        type: "Vision Tool",
      },
      {
        title: "Foresight Framework - Paper Mockups (p. 140)",
        type: "Vision Tool",
      },
      {
        title: "Foresight Framework - Dark Horse Prototypes (p. 150)",
        type: "Vision Tool",
      },
      {
        title: "Foresight Framework - Change Paths (p. 154)",
        type: "Team Tool",
      },
      {
        title: "Foresight Framework - Buddy Checks (p. 174)",
        type: "Team Tool",
      },
      {
        title: "Foresight Framework - VOICE Stars (p. 184)",
        type: "Team Tool",
      },
      {
        title: "Foresight Framework - Crowd Clovers (p. 194)",
        type: "Team Tool",
      },
    ],
    indicators: [
  ...
  },
  {
    ...
    description:
      "Turn plans into action by testing and validating your innovation in a real-world setting, while building capacity for broader implementation.",
    activities: [
  ...
  },
  {
    ...
    description:
      "Transition from implementation to sustained deployment, ensuring the solution is fully integrated and functioning across the organization.",
    activities: [
...

  {
    ...
    description:
      "Assess the performance of the deployed solution, gather feedback, and optimize processes for continuous improvement and future innovation efforts.",
    activities: [
