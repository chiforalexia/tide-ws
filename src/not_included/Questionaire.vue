<template>
  <div class="container mx-auto px-4 py-32 max-w-2xl">
    <div
      class="card border-purple-200 shadow-lg hover:shadow-xl transition-shadow duration-300"
    >
      <div
        class="card-header bg-gradient-to-r from-blue-300 to-blue-200 rounded-t-lg p-6"
      >
        <h2 class="text-2xl text-blue">Your Institution Profile</h2>
        <p class="text-gray-600">
          Tell us about your institution to receive personalized technology
      ...
      <div class="card-content pt-6 p-6">
        <form @submit.prevent="onSubmit" class="space-y-8">
          <!-- Institution -->
          <div
            class="form-item transition-all duration-300 hover:-translate-y-0.5"
          >
            ...
            <select
              ...
              class="input border-purple-200 focus:ring-purple-500 w-full"
            >
          ...
          <!-- Institution Size -->
          <div
            class="form-item space-y-3 transition-all duration-300 hover:-translate-y-0.5"
          >
          ...
          >
            <label
              class="flex items-center gap-2 text-green-600 text-base mb-1"
            >
...
export default {
  setup() {
    ...
    const institutions = [
      {
        value: "aeres-group-groenhorst-college",
        label: "Aeres Group (Groenhorst College)",
      },
      {
        value: "aeres-group-groenhorst-college",
        label: "Aeres Group (Groenhorst College)",
      ...
      {
        value: "amsterdam-school-of-the-arts",
        label: "Amsterdam School of the Arts",
      },
      { value: "amsterdam-umc", label: "Amsterdam UMC" },
      {
        value: "artEZ-university-for-the-arts",
        label: "ArtEZ University for the Arts",
      },
      {
        value: "avans-university-of-applied-sciences",
      ...
      {
        value: "driestar-university-of-applied-sciences",
        label: "Driestar University of Applied Sciences",
      },
      {
      ...
      {
        value: "ede-university-of-applied-sciences",
        label: "Ede University of Applied Sciences",
      },
      {
        value: "erasmus-university-medical-centre",
        label: "Erasmus University Medical Centre",
      },
      {
      ...
      {
        value: "fontys-universities-of-applied-sciences",
        label: "Fontys Universities of Applied Sciences",
      },
      ...
      {
        value: "groningen-university-of-applied-sciences",
        label: "Groningen University of Applied Sciences",
      },
      ...
      {
        value: "has-university-of-applied-sciences",
        label: "HAS University of Applied Sciences",
      },
      {
      ...
      {
        value: "integral-cancer-centre-of-the-netherlands",
        label: "Integral Cancer Centre of the Netherlands",
      },
      {
        value: "iselinge-university-of-applied-sciences",
        label: "Iselinge University of Applied Sciences",
      },
      {
        value: "kempel-university-of-applied-sciences",
        label: "Kempel University of Applied Sciences",
      },
      { value: "knmi", label: "KNMI" },
      {
        value: "kpz-university-of-applied-sciences",
        label: "KPZ University of Applied Sciences",
      },
      { value: "landstede-mbo", label: "Landstede MBO" },
      {
        value: "leiden-instrumentation-school",
        label: "Leiden Instrumentation School",
      },
      { value: "leiden-university", label: "Leiden University" },
      {
        value: "leiden-university-medical-centre",
        label: "Leiden University Medical Centre",
      },
      { value: "lentiz-onderwijsgroep", label: "Lentiz Onderwijsgroep" },
      { value: "maastricht-university", label: "Maastricht University" },
      {
        value: "maastricht-university-hospital",
        label: "Maastricht University Hospital",
      },
      ...
      {
        value: "netherlands-forensic-institute",
        label: "Netherlands Forensic Institute",
      },
      {
        value: "netherlands-organisation-for-scientific-research",
        label: "Netherlands Organisation for Scientific Research",
      },
      ...
      {
        value: "roc-van-amsterdam-flevoland",
        label: "ROC van Amsterdam-Flevoland",
      },
      { value: "roc-of-twente", label: "ROC of Twente" },
      { value: "royal-library", label: "Royal Library" },
      {
        value: "royal-netherlands-academy-of-arts-and-sciences",
      ...
      {
        value: "svo-foundation-for-vocational-education",
        label: "SVO Foundation for Vocational Education",
      },
      ...
      { value: "tno", label: "TNO" },
      {
        value: "university-for-humanistics",
        label: "University for Humanistics",
      },
      { value: "university-of-amsterdam", label: "University of Amsterdam" },
      {
        value: "university-of-applied-sciences-amsterdam",
        label: "University of Applied Sciences Amsterdam",
      },
      {
        value: "university-of-applied-sciences-inholland",
        label: "University of Applied Sciences Inholland",
      },
      {
        value: "university-of-applied-sciences-ipabo",
        label: "University of Applied Sciences iPabo",
      },
      {
        value: "university-of-applied-sciences-leiden",
        label: "University of Applied Sciences Leiden",
      },
      {
        value: "university-of-applied-sciences-rotterdam",
        label: "University of Applied Sciences Rotterdam",
      },
      {
        value: "university-of-applied-sciences-utrecht",
        label: "University of Applied Sciences Utrecht",
      },
      {
        value: "university-of-applied-sciences-viaa",
        label: "University of Applied Sciences Viaa",
      },
      {
        value: "university-of-arnhem-and-nijmegen",
        label: "University of Arnhem and Nijmegen",
      },
      { value: "university-of-groningen", label: "University of Groningen" },
      { value: "university-of-twente", label: "University of Twente" },
      {
        value: "utrecht-school-of-the-arts",
        label: "Utrecht School of the Arts",
      },
      { value: "utrecht-university", label: "Utrecht University" },
      {
        value: "van-hall-larenstein-university-of-applied-sciences",
        label: "Van Hall Larenstein University of Applied Sciences",
      },
      { value: "windesheim", label: "Windesheim" },
      { value: "willem-i-college", label: "Willem I College" },
      {
        value: "wood-and-furnishings-college",
        label: "Wood and Furnishings College",
      },
      ...
      {
        value: "zuyd-university-of-applied-sciences",
        label: "Zuyd University of Applied Sciences",
      },
    ];
