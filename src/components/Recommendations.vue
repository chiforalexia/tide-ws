    ...
    <div class="container mx-auto px-4 py-16 max-w-5xl">
      ...
      <div ref="pdfContent">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
              ...
              <div class="bg-green-50 p-4 rounded-lg">
                ...
                <div class="flex flex-wrap gap-2">
                  ...
                  <span v-if="selectedValueLabels.length === 0" class="text-gray-500 text-sm">No values selected</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          ...
          >
            <div class="flex flex-row items-center gap-4 bg-gradient-to-r from-white to-gray-50 p-4">
              <div
                class="p-2 rounded-full"
                :style="{ backgroundColor: `hsla(${(index * 50) % 360}, 70%, 95%, 0.5)` }"
              >
                <!-- Simplified SVG icon based on the category -->
                <svg v-if="category.icon === 'Laptop'" class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 18V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v13h20zM2 18h20v2a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-2z"></path></svg>
                <svg v-if="category.icon === 'Server'" class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3h18v18H3z"></path><path d="M3 6h18M3 12h18M3 18h18"></path></svg>
                <svg v-if="category.icon === 'HardDrive'" class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12h20M12 2v20"></path></svg>
                <svg v-if="category.icon === 'Database'" class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h18M3 10h18M3 15h18M3 20h18"></path></svg>
                <svg v-if="category.icon === 'BookOpen'" class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z"></path><path d="M4 12h16"></path></svg>
              </div>
              <div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        techCategories: [
          {
            ...
            description: "Interactive tools designed for engaging learning environments.",
            icon: "Laptop",
            recommendations: [
          ...
          },
          {
            ...
            description: "Solutions for organizing and utilizing institutional data.",
            icon: "Database",
            recommendations: [
        ...
        valueToTechMapping: {
          "innovation": ["AI research assistants", "Quantum computing access points", "Mixed reality learning pods"],
          "accessibility": ["Adaptive learning platforms", "Collaborative digital whiteboards", "Privacy-preserving analytics"],
          "sustainability": ["Green data center solutions", "Federated learning platforms", "Edge computing clusters"],
          "cost-efficiency": ["Hyperconverged infrastructure", "AI-generated curriculum tools", "Blockchain credential verification"],
          "global-collaboration": ["Distributed computing frameworks", "Collaborative digital whiteboards", "Immersive content libraries"],
          "data-privacy": ["Privacy-preserving analytics", "Blockchain credential verification", "Federated learning platforms"],
          "personalized-learning": ["Adaptive learning platforms", "AI-powered smart projectors", "AI-generated curriculum tools"]
        }
      };
    },
    computed: {
    ...
    methods: {
      getPersonalizedRecommendations(category) {
        ...
        const recs = category.recommendations.filter(rec =>
          this.selectedValues.some(val => this.valueToTechMapping[val]?.includes(rec))
        );
        return recs.length > 0 ? recs : category.recommendations;
      },
      isRecommended(rec) {
        return this.selectedValues.some(val => this.valueToTechMapping[val]?.includes(rec));
      },
      handleDownload() {
