    ...
    <div class="mx-auto w-full max-w-6xl px-4">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div
          ...
          "
        >
          <span class="bubble"> Discover The Roadmap </span>
          <h2 class="text-3xl md:text-4xl font-bold mb-6">
            A Step-by-Step Guide to
            <span class="text-blue-700">Successful Implementation</span>
          </h2>
          <p class="text-lg mb-8">
            The detailed roadmap breaks down the technology adoption and
            integration process into manageable phases, providing clear guidance
            and resources for each step of your journey.
          </p>
  ...
  <div class="card">
    ...
    <div class="space-y-4">
      <div
        ...
        :class="{
          'bg-gray-100 scale-[1.03]': activeStep === index,
          'hover:bg-gray-50': activeStep !== index
        }"
        @click="setActiveStep(index)"
      >
        <!-- Step Bubble -->
        <div
          class="w-10 h-10 rounded-full flex items-center justify-center font-semibold mr-4 flex-shrink-0"
          :class="[
            step.color,
        ...
        <span
          ...
          class="w-3 h-3 rounded-full bg-blue-600 animate-ping opacity-75 ml-auto mr-6"
        ></span>
      </div>
    </div>
