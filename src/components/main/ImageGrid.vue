  ...
  <section id="technologies" class="py-24">
    <div class="container mx-auto px-4 mb-12">
      ...
      <div class="text-center">
        <!-- Badge -->
        <div class="bubble">Technologies</div>
        ...
        <p class="text-gray-600 max-w-2xl mx-auto">
          Explore how emerging technologies are shaping the future of research
          and innovation through the Chapters of the Tech Trends Report.
        </p>
      </div>
    </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          >
            ...
            >
              <!-- Content -->
              <div class="px-6 py-3">
                <h3 class="text-white text-xl md:text-2xl font-bold mb-7">
                  {{ section.title }}
                </h3>
                ...
                >
                  ...
                  <div class="text-right">
                    <button
                      class="px-2 py-2 border-2 border-white text-white rounded-full bg-transparent hover:bg-white hover:text-black transition-colors duration-300"
                    >
                      Learn More
                    </button>
                  </div>
    ...
    >
      ...
      <div
        class="relative w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col"
      ...
      >
        ...
        >
          ...
          >
            <div
              class="max-w-6xl w-full space-y-8 overflow-y-auto"
              style="max-height: calc(100vh - 8rem)"
            >
              <!-- Header with larger image -->
              <div class="flex items-start gap-8">
                <div class="flex-1">
                  <h2 class="text-5xl font-bold text-gray-800 py-6">
                    {{ section.title }}
                  </h2>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                  <!-- Subchapters Box -->
                  <div
                    class="bg-gray-50 rounded-xl p-8 shadow-lg border border-blue-500"
                  >
                    ...
                    <ul class="space-y-4">
                      ...
                      >
                        <div
                          class="w-2 h-2 rounded-full bg-blue-500 mr-4"
                        ></div>
                        {{ subChapter }}
                      </li>
                    </ul>
                ...
                <div class="space-y-10">
                  <!-- Technologies Box -->
                  <div
                    class="bg-gray-50 rounded-xl p-6 shadow-lg border border-green-500"
                  >
                    <div class="flex items-center gap-2 mb-4">
                      ...
                      <h3 class="text-xl font-semibold text-gray-800">
                        Initiatives included in the Report
                      </h3>
                    </div>
                    <ul class="space-y-3">
                      <li
                      ...
                      >
                        <div
                          class="w-2 h-2 rounded-full bg-green-500 mr-3"
                        ></div>
                        {{ tech }}
                      </li>
                    </ul>
        ...
        <div
          class="absolute bottom-4 right-4 flex items-center gap-4 bg-white rounded-full p-0.5 shadow-lg"
        >
          <button
            @click="scroll('left')"
...
const sections = ref<Section[]>([
  {
    ...
    description:
      "Artificial Intelligence (AI) and, more specifically, Machine Learning (ML) continue to evolve, leading to both groundbreaking achievements and ethical concerns.",
  ...
  },
  {
    ...
    description:
      "Solving societal challenges with digital research infrastructure on a global scale requires a unique combination of computing, storage, and networking technologies.",
  ...
  },
  {
    ...
    title: "Quantum",
    description:
      "Quantum technologies span computing, communication, and sensing, promising exponential performance improvements and novel applications.",
  ...
  },
  {
    ...
    title: "Edge",
    description:
      "Edge computing enables real-time, distributed processing and automation close to the data source, supporting smart environments and systems.",
  ...
  },
  {
    ...
    title: "Network",
    description:
      "Modern networks support intelligent connectivity and architectural flexibility across cloud, edge, and enterprise environments.",
  ...
  },
  {
    ...
    description:
      "XR, or 'eXtended Reality' is both a technology in its own right, as well as a term used for a combination of other reality-altering technologies; combinations of virtual reality, augmented reality and mixed reality could all constitute XR.",
