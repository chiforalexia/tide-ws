<template>
  <div>
    <!-- Header -->
    <h1
      class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center m-2 text-black-800"
    >
      Implementation Roadmap
    </h1>

    <p
      class="sm:text-lg md:text-xl text-gray-600 max-w-3xl m-4 text-center mx-auto"
    >
      With the SURF Tech Trends Report in hand, you’ve taken the first step:
      <span class="font-bold">
        gaining insight into the signals shaping the future of education and
        research.
      </span>
      These aren’t instructions but an invitation to reflect, translate, and
      act.
    </p>

    <div class="text-sm sm:text-base md:text-lg text-blue-600 m-8 text-center">
      You’re not expected to follow a fixed path, but to create one, using these
      phases as support.
    </div>
          ...
          <div v-for="(phase, index) in phases" :key="index">
            <button
              ...
              :class="[
                ...
                activePhase === index
                  ? 'surf-blue-100-background border-blue-500 ring-2 ring-surf-blue-200'
          ...
          >
            <transition name="fade" mode="out-in">
              ...
              >
                ...
                <h2
                  class="text-3xl font-bold mb-4 text-blue-700 flex items-center"
                >
                ...
                <div
                  ...
                  class="relative bg-gray-100 p-6 rounded-xl shadow-inner mb-6"
                >
                  <!-- Close Button -->
                  <button
                  ...
                  >
                    <!-- Text -->
                    <div
                      class="md:w-2/3 text-gray-800 text-base leading-relaxed"
                    >
                    ...
                    <!-- Image -->
                    <div
                      v-if="phases[activePhase].justificationImage"
                ...
                <div class="grid md:grid-cols-3 gap-8">
                  ...
                  <div class="md:col-span-2 space-y-10">
                    ...
                    <!-- Optional Note Box -->
                    <div
                      v-if="phases[activePhase].note"
                      class="border-l-4 border-surf-orange-400 p-4 rounded-lg background-surf-orange-100 space-y-1 ring-1 ring-surf-orange-400"
                    >
                      <h3 class="text-lg font-semibold surf-orange-500">
                        Note
                      </h3>
                    ...
                    <div>
                      <div class="flex items-center gap-2 mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-black-800">
                          Key Activities
                        </h3>
                      </div>
                      ...
                      <ul class="space-y-2">
                        ...
                        >
                          ...
                          <div class="pl-12 space-y-2 text-gray-600">
                            <div
                              v-for="(detail, j) in activity.details"
                              :key="j"
                              v-html="detail"
                            ></div>
                          </div>
                          ...
                          <!-- Tools (if available) -->
                          <div
                            v-if="activity.tools && activity.tools.length"
                            class="pl-16 mt-3"
                          >
                            ...
                            <ul
                              class="list-disc space-y-1 text-gray-500 text-sm pl-4"
                            >
                    ...
                    <div>
                      <div class="flex items-center gap-2 mb-4">
                        ...
                        >
                          ...
                          <path
                            d="M5.5 21h13a1 1 0 0 0 1-1v-1c0-2.5-2-4.5-4.5-4.5h-6A4.5 4.5 0 0 0 4 19v1a1 1 0 0 0 1.5 1z"
                          />
                        </svg>
                        <h3 class="text-xl font-semibold text-gray-800">
                      ...
                      <div class="text-gray-700">
                        <ul
                          v-if="
                            Array.isArray(
                              phases[activePhase].stakeholderEngagement,
                            )
                          "
                          class="list-disc pl-5 space-y-1"
                        >
                          <li
                            v-for="(item, index) in phases[activePhase]
                  ...
                  <!-- Resources -->
                  <div
                    class="bg-gray-50 p-6 rounded-xl shadow-lg border border-surf-blue-200 h-fit"
                  >
                    <div class="flex items-center gap-2 mb-6">
                      <svg
                        class="w-6 h-6 secondary-text"
                        fill="none"
                        stroke="currentColor"
                        stroke-width="2"
                        viewBox="0 0 24 24"
...
const phases = ref([
  {
    ...
    description:
      "Move from observing trends to making sense of them. This phase surfaces possibilities and helps imagine futures that can inform resilient, actionable strategies. It lays the groundwork for focused, future-ready planning.",
    activities: [
      {
      ...
      {
        activity:
          "Brainstorm using a Futures Wheel with the Tech Trends in mind",
        details: [
    ...
    stakeholderEngagement:
      "Engage a diverse group from the outset. Cross-functional participation strengthens the quality of insights and builds ownership for future strategy. Early stakeholder mapping ensures you know who to involve, inform, or consult as the process moves forward.",
    indicators: [
    ...
    resources: [
      {
        ...
        citation:
          "SURF. (2023). SURF Tech Trends 2023. https://www.surf.nl/en/tech-trends",
      },
      {
        title: "Brainstorm using the Futures Wheel",
        description:
          "In this activity, you'll generate ideas using a Futures Wheel, combining insights from the SURF Tech Trends Report with your own experiences and observations. The aim is to surface bold, surprising, or unconventional ideas.",
        tips: [
        ...
        citation:
          "Jerome C.  Glenn, & Gordon, T. J. (2009). Futures Research Methodology (3.0). The Millennium Project. https://millennium-project.org/publications/futures-research-methodology-version-3-0-2/",
      },
      {
        title: "Futures Triangle",
        description:
          "Explore the forces influencing possible futures for your organization or sector by mapping key trends and drivers onto a Futures Triangle framework.",
        tips: [
      ...
      },
      {
        ...
        description:
          "This tool will help you identify and map critical uncertainties that could shape your future operating environment. You’ll select two high-impact, high-uncertainty factors and place them on intersecting axes to frame four plausible future scenarios.",
        tips: [
        ...
        citation:
          "Webb, A. (2020, March 16). How Futurists Cope With Uncertainty. The Startup. https://medium.com/swlh/how-futurists-cope-with-uncertainty-a4fbdff4b8c6; Schwartz, P. (1997). The Art of the Long View. Doubleday/Currency.",
      },
      {
        title: "Developing Scenarios",
        description:
          "In this activity you will develop detailed, plausible future narratives based on the four quadrants generated by your Axes of Uncertainty matrix. This helps teams stress-test strategies and identify opportunities and risks under different future conditions.",
        tips: [
      ...
      },
      {
        ...
        people: "Team (3–5 people)",
        exampleimage:
          "/public/phases_resources/images/readiness_assessment.png",
        citation:
          "Maastricht University. (2024). Maastricht Innovation Readiness Aanpak (MIRA). https://www.awolimburg.nl/nl/projecten/innovation-readiness",
      },
    ],
    justification:
...

  {
    ...
    subtitle:
      "From foresight to action - translating scenarios into strategic options, innovation opportunities, and implementation plans.",
    ...
    resources: [
      {
        title: "White Spots",
        description:
          "A visual tool to uncover gaps in your knowledge, assumptions, or strategic planning — the “unknown unknowns” that could affect your project or future scenarios. It helps make blind spots visible so you can address them early, while also surfacing overlooked opportunities.",
        tips: [
        ...
        exampleimage: "",
        citation:
          "Carleton, T., Cockayne, W., & Tahvanainen, A.-J. (2013). Playbook for Strategic Foresight and Innovation, p.45. https://web.stanford.edu/group/archaeolog/cgi-bin/archaeolog/wp-content/uploads/2020/05/Playbook-for-Strategic-Foresight-and-Innovation-US-Stanford.pdf",
      },
      {
        title: "Backcasting",
        description:
          "Backcasting is a strategic planning method that starts with defining a desirable future and then works backward to identify the policies, actions, and steps needed to connect that specified future to the present.",
        tips: [
      ...
      },
      {
        ...
        description:
          "A strategic tool for assessing how prepared your organization is for a range of future scenarios. Adapted from Scott Smith’s *How to Future*, it helps teams map potential futures against current capabilities, identify readiness gaps, and spot areas needing action.",
        tips: [
        ...
        exampleimage: "",
        citation:
          "Smith, S., & Ashby, M. (2020). How To Future: Leading and Sense-making in an Age of Hyperchange. Kogan Page Inspire. https://www.howtofuture.com",
      },
      {
        title: "Visioning Canvas (Five Bold Steps Canvas)",
        description:
          "A visual tool to co-create a clear, inspiring vision for the future. Developed by David Sibbet, it helps teams map out their ideal future state, key themes, enablers, challenges, and five bold steps toward success.",
        tips: [
        ...
        exampleimage: "",
        citation:
          "The Grove Consultants International. (2024). Strategic Visioning Process Outline. https://www.thegrove.com/sv-process-overview-download; Fransen, R. (2020, July 15). Vision Canvas | Business Model Innovatie | Five Bold Steps Canvas. https://www.businessmodelinnovatie.nl/vision-canvas/",
      },
      {
        title: "Innovation Ambition Matrix",

        description:
          "This framework helps you categorize and balance your innovation initiatives based on their ambition: Core (optimize existing offerings), Adjacent (expand into new areas), and Transformational (create entirely new markets or business models). It ensures your innovation portfolio includes a healthy mix of incremental improvements and bold future bets.",
        tips: [
      ...
      },
      {
        ...
        description:
          'This framework visualizes projects based on relative cost and potential impact. It helps leadership identify "quick wins," "big bets," and areas that may need to be deprioritized or redesigned.',
        tips: [
        ...
        exampleimage: "",
        citation:
          "Jerome C. Glenn, & Gordon, T. J. (2009). Futures Research Methodology (3.0). The Millennium Project. https://millennium-project.org/publications/futures-research-methodology-version-3-0-2/; Mahaffie, J. (2018, March 9). How to use cross impact analysis. Foresight Culture. https://foresightculture.com/2018/03/09/how-to-use-cross-impact-analysis",
      },
      {
        title: "Crowd Clovers",

        description:
          "Crowd Clovers is a simple tool for mapping your personal or team’s innovation network. It helps visualize who you’re connected to, where ideas and feedback come from, and where important gaps might exist.",
        tips: [
        ...
        exampleimage: "",
        citation:
          "Carleton, T., Cockayne, W., & Tahvanainen, A.-J. (2013). Playbook for Strategic Foresight and Innovation. https://web.stanford.edu/group/archaeolog/cgi-bin/archaeolog/wp-content/uploads/2020/05/Playbook-for-Strategic-Foresight-and-Innovation-US-Stanford.pdf",
      },
      {
        title: "SWOT Analysis",
        ...
        exampleimage: "",
        citation:
          "Van der Heijden, K. (2005). Scenarios: The Art of Strategic Conversation. Wiley; Luoto, L., & Lonkila, A. (2018). The Use of SWOT Analysis for Future Scenarios: A Case Study of Privacy and Emerging Technologies. In *Envisioning Uncertain Futures* (pp. 105–131). Springer VS, Wiesbaden. https://doi.org/10.1007/978-3-658-25074-4_7",
      },
      {
        title: 'Must-Win "Battles"',
        type: "Strategic Planning",
        description:
          "Identify the critical priorities your organization must win in the next planning horizon to achieve its strategic goals. Use this tool to focus resources and leadership attention where it matters most.",
        tips: [
        ...
        url: "https://books.google.nl/books?hl=en&lr=&id=RFvrtu9xxkcC&oi=fnd&pg=PT8&dq=Killing,+J.+P.,+Killing,+P.,+Malnight,+T.,+%26+Keys,+T.+(2005).+Must-win+battles:+How+to+win+them,+again+and+again.+Wharton+School+Pub.&ots=4wAiX3obFH&sig=iDpS_4MqYsp48Jk3QIQGeJivpq0&redir_esc=y#v=onepage&q&f=false",
        time: "1–2 hours",
        people: "Individual or team",
        exampleimage: "",
        citation:
          "Killing, J. P., Killing, P., Malnight, T., & Keys, T. (2005). *Must-win battles: How to win them, again and again*. Wharton School Pub.",
      },
      {
        title: "Voice Stars",
        type: "Strategic Planning",
        description:
          'Voice Stars is a diagnostic tool that can help to assess the leadership potential of individuals and teams for driving radical innovation. It helps identify "star-shaped" leaders: individuals with the unique blend of traits needed to guide innovation. It also reveals how well a team supports collective innovation leadership.',
        tips: [
      ...
      },
      {
        ...
        type: "Strategic Planning",
        description:
          "A quick, low-cost way to turn abstract ideas into tangible models. Use simple materials, like paper and markers, to prototype a service, system, or concept and test it with others. Use as a tool for alignment before investing resources.",
        tips: [
      ...
      },
      {
        ...
        description:
          "A fast, physical prototype of a previously rejected, risky, or forgotten idea. It's a way to refocus on what really matters and possibly uncover hidden opportunity.",
        tips: [
        ...
        exampleimage: "",
        citation:
          "Carleton, T., Cockayne, W., & Tahvanainen, A.-J. (2013). Playbook for Strategic Foresight and Innovation (p. 145). https://web.stanford.edu/group/archaeolog/cgi-bin/archaeolog/wp-content/uploads/2020/05/Playbook-for-Strategic-Foresight-and-Innovation-US-Stanford.pdf",
      },
      {
        title: "Wind Tunneling",
        type: "Strategic Planning",
        description:
          "A structured exercise to pressure-test ideas against multiple possible futures. Wind-tunnelling helps teams stress-test strategies against pre-developed future scenarios. Helps uncover risks and blind spots by simulating how your strategy would hold up in different scenarios.",
        tips: [
      ...
      },
      {
        ...
        type: "Strategic Planning",
        description:
          "Change Paths helps teams explore multiple routes toward future innovations. Prioritize top decisions based on their ability to move the organization toward its desired future. This method acknowledges that innovation is rarely linear, encouraging teams to visualize and plan for a flexible, yet focused path forward.",
        tips: [
  ...
  },
  {
    ...
    stakeholderEngagement:
      "Stakeholders become co-pilots. Engage frontline users in prototyping, feedback loops, and iterative design. Their insights could drive success, and build long-term ownership.",
    ...
    resources: [
      {
        ...
        description:
          "A Pilot Project Plan is a practical, structured document your team creates to outline how an innovation will be tested in a real-world setting. Many institutions already have processes or formats for this but if you are looking for a refresher you can adapt this template.",
        tips: [
      ...
      },
      {
        ...
        type: "Pilot Experimentation",
        description:
          "Visual tools to organize your pilot into manageable sprints or timelines. They help teams track progress, surface blockers, and stay focused on short-term deliverables without losing sight of the big picture.",
        tips: [
...

  {
    ...
    description:
      "This phase is about moving from successful pilots to consistent, organization-wide adoption. It focuses on rolling out your solution with clear structure, strong support systems, and thoughtful communication.",
    ...
    resources: [
      {
        ...
        description:
          "A detailed list to ensure nothing critical is missed when scaling from pilot to organization-wide rollout. Keeps teams aligned and confident during complex transitions.",
        tips: [
      ...
      },
      {
        ...
        type: "Full Deployment",
        description:
          "Step-by-step guidance tailored to different user roles. Reduces confusion and supports confident adoption across diverse stakeholders.",
        tips: [
        ...
        exampleimage: "no pic",
        citation:
          "Olmstead, L. (2023, August 2). How to Create a User Guide (Examples, Tips, Tools). The Whatfix Blog | Drive Digital Adoption. https://whatfix.com/blog/user-guides/",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Once deployed, it's time to evaluate impact, adapt based on feedback, and build a foundation for future improvement.",
    activities: [
      {
    ...
    stakeholderEngagement: [
      "Close the Loop - Share back what you’ve learned and how you’re improving.",
      "Invite Critique - Create safe spaces for honest feedback and refinement ideas.",
      "Keep Futuring in the Conversation - Regularly check in on how current initiatives fit with your anticipated future and emerging challenges.",
    ],
    resources: [
      {
        ...
        description:
          "A structured process for reflecting on a completed project or initiative to assess its effectiveness and identify lessons learned. Originally developed by the U.S. Army, AARs have been widely adopted in various sectors for continuous improvement.",
        tips: [
        ...
        exampleimage: "no pic",
        citation:
          "Baškarada, S., McKay, T., & McKenna, T. (2013). Technology deployment process model. *Operations Management Research, 6*(3–4), 105–118. https://doi.org/10.1007/s12063-013-0082-5",
      },
    ],
  },
]);
