    ...
    <div class="grid md:grid-cols-12 gap-8">
      ...
      <div class="hidden md:block md:col-span-4 space-y-4">
        <div
          ...
          :class="{
            'surf-border-blue-main bg-white shadow-md':
        ...
        >
          <div
            ...
            :class="
              story.id === selectedStoryId ? 'surf-blue-main' : 'bg-gray-300'
            "
          ></div>
          <div>
      ...
      <!-- Main Content -->
      <div
        class="md:col-span-8 bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden transition"
      >
        <div class="grid md:grid-cols-2 h-full">
          ...
          <div class="p-6">
            ...
            <div class="mb-6">
              ...
              <ul class="space-y-2">
                <li
                  v-for="(outcome, index) in selectedStory.outcomes"
                  :key="index"
            ...
            <blockquote
              class="italic text-gray-700 border-l-4 border-gray-200 pl-4 mb-4"
            >
              {{ selectedStory.quote }}
            </blockquote>
